...
void mlx_clear_window(mlx_ptr_t *mlx_ptr, window_list_t *win_ptr)
{
...
void mlx_expose_hook(window_list_t *win_ptr, int (*funct_ptr)(), void *param)
{
  [(id)(win_ptr->winid) setEvent:12 andFunc:funct_ptr andParam:param];
}

void mlx_key_hook(window_list_t *win_ptr, int (*funct_ptr)(), void *param)
{
  [(id)(win_ptr->winid) setEvent:3 andFunc:funct_ptr andParam:param];
}

void mlx_mouse_hook(window_list_t *win_ptr, int (*funct_ptr)(), void *param)
{
  [(id)(win_ptr->winid) setEvent:4 andFunc:funct_ptr andParam:param];
}

void mlx_hook(window_list_t *win_ptr, int x_event, int x_mask, int (*funct_ptr)(), void *param)
{
...
int     mlx_destroy_window(mlx_ptr_t *mlx_ptr, window_list_t *win_to_del)
{
  window_list_t    first;
  window_list_t    *win;
  mlx_img_ctx_t	    *ctx;
