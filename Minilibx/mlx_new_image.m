...
mlx_img_ctx_t	*add_img_to_ctx(mlx_img_list_t *img, window_list_t *win)
{
...
void    mlx_put_image_to_window(mlx_ptr_t *mlx_ptr, window_list_t *win_ptr, mlx_img_list_t *img_ptr, int x, int y)
{
  mlx_img_ctx_t	*imgctx;
...
int mlx_string_put(mlx_ptr_t *mlx_ptr, window_list_t *win_ptr, int x, int y, int color, unsigned char *string)
{
  mlx_img_ctx_t	*imgctx;
  int		gX;
  int		gY;
